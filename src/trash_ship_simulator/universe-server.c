...
int main(int argc, char *argv[])
{
    ...
    Player *currPlayer;
    uint8_t newID;
    uint8_t spaceships[game_state->n_planets];

    int nNewPlayers=1;
    int running = 1;
    int spaceshipNum;

    for(spaceshipNum = 0; spaceshipNum<game_state->n_planets;spaceshipNum++)
